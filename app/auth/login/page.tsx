    ...
    <main className="flex min-h-[85vh] items-center justify-center p-6">
      <div className="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl backdrop-blur-xl">
        <div className="text-center">
          ...
          <h1 className="mt-3 text-3xl font-extrabold text-white">Hero Login</h1>
          <p className="mt-1 text-xs text-slate-400">Resume your 28-day Python RPG adventure</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          >
            {loading ? "Authenticating..." : "Log In & Enter Realm"}
          </button>
        </form>

        <p className="mt-6 text-center text-xs text-slate-400">
          Don't have a hero account?{" "}
          <a href="/auth/signup" className="font-bold text-cyan-400 hover:underline">
            Sign Up Here
          </a>
        </p>
      </div>
